...
public class JavaStatementBuilderTest {
  ...
  public void shouldLexAnnotationStatement() {
    ...
    assertThat(statementList.get(1).getValue(), is("@Table(name=$CHARS)"));
    assertThat(statementList.get(2).getValue(), is("publicclassPropertyextendsBaseIdentifiable"));
    assertThat(statementList.get(3).getValue(), is("@Column(name=$CHARS,updatable=true,nullable=true)"));
    assertThat(statementList.get(4).getValue(), is("privateStringkey"));
    assertThat(statementList.get(5).getValue(), is("@Column(name=$CHARS,updatable=true,nullable=true,length=$NUMBER)"));
  ...
  public void shouldLexIfStatement() {
    ...
    assertThat(statementList.get(2).getValue(), is("if(id.length()>$NUMBER)"));
    assertThat(statementList.get(3).getValue(), is("id+=File.separator"));
    assertThat(statementList.get(4).getValue(), is("elseif(id.length()==-$NUMBER)"));
    assertThat(statementList.get(5).getValue(), is("id+=$CHARS"));
    assertThat(statementList.get(6).getValue(), is("if(id.length()==$NUMBER)"));
    assertThat(statementList.get(7).getValue(), is("returnlocalname"));
    assertThat(statementList.get(8).getValue(), is("if(id.length()==$NUMBER)"));
  ...
  public void shouldLexForStatement() {
    ...
    assertThat(statementList.get(0).getValue(), is("for(inti=$NUMBER;i<children.length;i++)"));
    assertThat(statementList.get(1).getValue(), is("total+=i"));
    assertThat(statementList.get(2).getValue(), is("for(inti=$NUMBER;i<children.length;i++)"));
    assertThat(statementList.get(3).getValue(), is("total+=i"));
    assertThat(statementList.get(4).getValue(), is("for(inti=$NUMBER;i<children.length;i++)"));
  ...
  public void shouldLexSwitchStatement() {
    ...
    assertThat(statementList.get(1).getValue(), is("case$NUMBER:"));
    assertThat(statementList.get(2).getValue(), is("monthString=$CHARS"));
    assertThat(statementList.get(3).getValue(), is("break"));
    assertThat(statementList.get(4).getValue(), is("case$NUMBER:"));
    assertThat(statementList.get(5).getValue(), is("monthString=$CHARS"));
    assertThat(statementList.get(6).getValue(), is("break"));
    assertThat(statementList.get(7).getValue(), is("case$NUMBER:"));
    assertThat(statementList.get(8).getValue(), is("monthString=$CHARS"));
    assertThat(statementList.get(9).getValue(), is("break"));
    assertThat(statementList.get(10).getValue(), is("default:"));
    assertThat(statementList.get(11).getValue(), is("monthString=$CHARS"));
  }
