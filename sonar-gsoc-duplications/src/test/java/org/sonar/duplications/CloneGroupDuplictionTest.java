...
import org.sonar.duplications.java.JavaCloneGroupFinder;

public class CloneGroupDuplictionTest {
	...
	CloneGroupFinder cf = JavaCloneGroupFinder.build(mci); 
	...
	public void shouldReportCloneWithSmallBlockSize() {
		...
		cf = JavaCloneGroupFinder.build(mci, 4); 
	...
	public void shouldNotReportCloneSmallerThanBlockSize() {
		...
		cf = JavaCloneGroupFinder.build(mci, 5); 
