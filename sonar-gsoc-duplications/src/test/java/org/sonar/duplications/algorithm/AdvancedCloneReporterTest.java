...
public class AdvancedCloneReporterTest extends BaseCloneReporterTest {
  ...
  public void testSimple() {
    ...
    CloneGroup expected1 = newCloneGroup(4,
        new ClonePart("a", 3, 3, 11),
        new ClonePart("b", 2, 2, 10));

    CloneGroup expected2 = newCloneGroup(3,
        new ClonePart("a", 5, 5, 12),
        new ClonePart("c", 1, 1, 8));
  ...
  public void testSameClones() {
    ...
    CloneGroup expected = newCloneGroup(3,
        new ClonePart("a", 1, 1, 8),
        new ClonePart("b", 1, 1, 8),
        new ClonePart("c", 1, 1, 8));
  ...
  public void testBegin() {
    ...
    CloneGroup expected = newCloneGroup(2,
        part1,
        part2);
    assertThat(items, hasItem(expected));
  }
  ...
  public void testDuplicatesSameFile1() {
    ...
    CloneGroup expected = newCloneGroup(1,
        part1,
        part2);
    assertThat(items, hasItem(expected));
  }
  ...
  public void testDuplicatesSameFileTriangle() {
    ...
    CloneGroup expected = newCloneGroup(1,
        ...
        new ClonePart("a", 4, 4, 9),
        new ClonePart("a", 7, 7, 12));
    assertThat(items, hasItem(expected));
  }
